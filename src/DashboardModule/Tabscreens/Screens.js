...
const [completedCount, setCompletedCount] = useState(0);
  ...
  const postcreatevisitData = useSelector(
    (state) => state.postcreatevisitReducer.data["VisitListTabListdata"] || []
  );
  const postcreatevisitLoading = useSelector(
    (state) => state.postcreatevisitReducer.loading["VisitListTabListdata"]
  );
...
useEffect(() => {
     ...
     dispatch(postcreatevisit(payload, "VisitListTabListdata"));
}, []);
              ...
              <View >
                ...
                >
                  <View style={styles.cardContent}>
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate('VisitListTab')}>
