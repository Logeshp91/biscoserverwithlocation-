    ...
    >
      <View style={VisitListTabStyles.card}>
        <View style={VisitListTabStyles.row}>
          <Text style={VisitListTabStyles.headerText}>
            {item.partner_id?.[1] || "-"}
          </Text>
          <Text style={[VisitListTabStyles.headerText, { fontSize: 10 }]}>
            {item.followup_date}
          </Text>
        </View>
        ...
        <View style={VisitListTabStyles.miniCard}>
          <View style={VisitListTabStyles.row}>
            <Text style={VisitListTabStyles.title}>{item.name}</Text>
...
const SaleOrderItem = ({ item }) => (
  <View style={VisitListTabStyles.card}>
    <View style={VisitListTabStyles.row}>
      <Text style={VisitListTabStyles.headerText}>{item.name}</Text>
      <Text style={[VisitListTabStyles.headerText, { fontSize: 10 }]}>
        {item.date_order}
      </Text>
    </View>
    ...
    <View style={VisitListTabStyles.miniCard}>
      <Text style={VisitListTabStyles.title}>
        Customer: {item.partner_id?.[1] || "-"}
      </Text>

      <Text style={VisitListTabStyles.value}>
