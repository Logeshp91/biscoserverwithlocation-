  ...
  return (
    <View style={VisitListTabStyles.card}>
      ...
      <View style={VisitListTabStyles.miniCard}>
        ...
        >
          <Text>
            <Text style={VisitListTabStyles.label}>Phone: </Text>
            <Text style={VisitListTabStyles.value}>{item.phone ?? "-"}</Text>
          </Text>
          <Text>
            <Text style={VisitListTabStyles.label}>Mobile: </Text>
            <Text style={VisitListTabStyles.value}>{item.mobile ?? "-"}</Text>
          </Text>
        </View>

        <Text style={{ marginVertical: 2 }}>
          <Text style={VisitListTabStyles.label}>Street: </Text>
          <Text style={VisitListTabStyles.value}>{item.street ?? "-"}</Text>
        </Text>

        <Text style={{ marginVertical: 2 }}>
          <Text style={VisitListTabStyles.label}>City: </Text>
          <Text style={VisitListTabStyles.value}>{item.city ?? "-"}</Text>
        </Text>

        <Text style={{ marginVertical: 2 }}>
          <Text style={VisitListTabStyles.label}>State: </Text>
          <Text style={VisitListTabStyles.value}>{stateName}</Text>
        </Text>

        <Text style={{ marginVertical: 4 }}>
          <Text style={VisitListTabStyles.label}>Outstanding: </Text>
          <Text
            style={[
              VisitListTabStyles.value,
  ...
  (pageNumber = 0, searchValue = "") => {
    ...
    const domainSearch = searchValue
      ? [
         ...
         ["state_id.name", "ilike", searchValue],
        ]
      : [];
...
const filteredData = useMemo(() => {
  ...
  return customers.filter((item) => {
    const name = String(item.complete_name ?? "").toLowerCase();
