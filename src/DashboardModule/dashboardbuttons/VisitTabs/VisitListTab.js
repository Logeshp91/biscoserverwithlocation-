...
import VisitListTabStyles from "../../Styles/VisitListTabStyles";
...
const fetchEnquiries = useCallback(
  (pageNumber = 0, status, searchText = "") => {
    ...
    dispatch(postcreatevisit(payload, "VisitListTabList"));
  },
  [dispatch]
);
...
useEffect(() => {
  ...
  const postcreatevisitLoading = useSelector(
    (state) => state.postcreatevisitReducer.loading["VisitListTabList"]
  );
  const postcreatevisitData = useSelector(
    (state) => state.postcreatevisitReducer.data["VisitListTabList"]
  );
...
const filteredCustomers = useMemo(() => {
  ...
  const renderItem = ({ item }) => {
    ...
    const OutstandingCard = React.memo(({ data }) => {
      ...
      return (
        <View style={VisitListTabStyles.summaryCard}>
          <View style={VisitListTabStyles.summaryHeader}>
            <View style={{ flexDirection: "row", alignItems: "center", }}>
              <Icon name="book" size={20} color="#24bc99" style={{ marginRight: 8 }} />
              <Text style={VisitListTabStyles.summaryHeaderText}>Invoice List</Text>
            </View>
          </View>
          <View style={VisitListTabStyles.summaryRow}>
            <View style={VisitListTabStyles.summaryItem}>
              <Text style={VisitListTabStyles.summaryLabel}>Invoice</Text>
            </View>
            <View style={VisitListTabStyles.summaryItem}>
              <Text style={VisitListTabStyles.summaryLabel}>Missed Days</Text>
            </View>
            <View style={VisitListTabStyles.summaryItem}>
              <Text style={VisitListTabStyles.summaryLabel}>Outstanding</Text>
            </View>
          </View>
          {data.map((a) => (
            <TouchableOpacity
              ...
              style={[
                VisitListTabStyles.summaryRow,
                { backgroundColor: "transparent", borderRadius: 8, marginBottom: 6 },
              ]}
            >
              <View style={VisitListTabStyles.summaryItem}>
                <Text style={VisitListTabStyles.summaryValue}>{a.name}</Text>
              </View>
              <View style={VisitListTabStyles.summaryItem}>
                <Text style={VisitListTabStyles.summaryValue}>{a.missed_days}</Text>
              </View>
              <View style={VisitListTabStyles.summaryItem}>
                <Text style={VisitListTabStyles.summaryValue}>{a.amount_residual}</Text>
              </View>
            </TouchableOpacity>
          ))}
    ...
    return (
      <View>
        <View style={VisitListTabStyles.card}>
          <View style={VisitListTabStyles.row}>
            <Text style={VisitListTabStyles.headerText}>{item.customer_name}</Text>
            <Text style={[VisitListTabStyles.headerText, { fontSize: 9 }]}>{item.followup_date}</Text>
          </View>
          {getOutstanding(item.customer_name) > 0 && (
            ...
            >
              <View style={{ flexDirection: "row", alignItems: "center", marginBottom: 5 }}>
                <Text style={VisitListTabStyles.OutstangingLabel}>OS:</Text>
                <Text style={VisitListTabStyles.OutstangingValue}>
          ...
          <View style={VisitListTabStyles.miniCard}>
            <View style={VisitListTabStyles.row}>
              <Text style={VisitListTabStyles.title}>{item.reference}</Text>
              <TouchableOpacity onPress={() => handleSoPress(item.id, item.so_number)}>
                <Text style={[VisitListTabStyles.title, { textDecorationLine: "underline", color: "#250588" }]}>
                  {item.so_number}
                </Text>
              </TouchableOpacity>
            </View>
            <View style={VisitListTabStyles.infoRow}>
              <View style={VisitListTabStyles.infoItem}>
                <Text style={VisitListTabStyles.label}>Product</Text>
                <Text style={VisitListTabStyles.value}>{item.product_category}</Text>
              </View>
              <View style={VisitListTabStyles.infoItem}>
                <Text style={VisitListTabStyles.label}>Brand</Text>
                <Text style={VisitListTabStyles.value}>{item.brand}</Text>
              </View>
              <View style={VisitListTabStyles.infoItem}>
                <Text style={VisitListTabStyles.label}>Visit</Text>
                <Text style={VisitListTabStyles.value}>{item.outcome_visit}</Text>
              </View>
              <View style={VisitListTabStyles.infoItem}>
                <Text style={VisitListTabStyles.label}>Status</Text>
                <Text style={VisitListTabStyles.value}>{item.state}</Text>
              </View>
            </View>
            <View style={[VisitListTabStyles.belowrow, { justifyContent: 'space-between', alignItems: 'center', paddingRight: 5 }]}>
              <View style={{ flexDirection: 'row', flexWrap: 'wrap', alignItems: 'center' }}>
                <Text style={[VisitListTabStyles.label, { marginRight: 5 }]}>Remarks:</Text>
        ...
        {clickedSoId === item.id &&
          ...
          item.so_number.trim() !== "-" &&
          item.so_number.trim() !== "" && (
            <View style={VisitListTabStyles.extraContainer}>
              <View style={VisitListTabStyles.extraRowBelow}>
                <View style={VisitListTabStyles.extraItem}>
                  <Text style={VisitListTabStyles.extraLabel}>Billing Type</Text>
                  <Text style={VisitListTabStyles.extraValue}>{item.billing_type || "-"}</Text>
                </View>
                <View style={VisitListTabStyles.extraItem}>
                  <Text style={VisitListTabStyles.extraLabel}>Billing Branch</Text>
                  <Text style={VisitListTabStyles.extraValue}>{item.billing_branch || "-"}</Text>
                </View>
                <View style={VisitListTabStyles.extraItem}>
                  <Text style={VisitListTabStyles.extraLabel}>Incoterm</Text>
                  <Text style={VisitListTabStyles.extraValue}>{item.incoterm || "-"}</Text>
                </View>
              </View>
              <View style={VisitListTabStyles.extraRowBelow}>
                <View style={VisitListTabStyles.extraItem1}>
                  <Text style={VisitListTabStyles.extraLabel}>Payment Terms</Text>
                  <Text style={VisitListTabStyles.extraValue}>{item.payment_term || "-"}</Text>
                </View>
              </View>
                  ...
                  <View style={VisitListTabStyles.summaryCard}>
                    <View style={VisitListTabStyles.summaryHeader}>
                      <Icon
                        ...
                        style={{ marginRight: 8 }}
                      />
                      <Text style={VisitListTabStyles.summaryHeaderText}>Product List</Text>


                    </View>
                    {item.products.map((prod) => (
                      <View key={prod.id} style={VisitListTabStyles.infoRow}>
                        <Text style={VisitListTabStyles.productName}>{prod.name}</Text>
                        <Text style={VisitListTabStyles.productvalue}>{prod.qty}</Text>
                      </View>
                    ))}
                    <View style={{ flexDirection: "row", justifyContent: "flex-end" }}>
                      ...
                      >
                        <Text style={VisitListTabStyles.viewproduct}>View Details</Text>
                        <Icon name="chevron-right" size={20} color="#250588" />
                      </TouchableOpacity>
                    </View>
                  </View>
  ...
  return (
    <ImageBackground
      ...
      style={VisitListTabStyles.background}
      resizeMode="cover"
    >
      <View style={VisitListTabStyles.container}>
        <View style={VisitListTabStyles.tabsContainer}>
          {["CustomerList", "VisitList", "TodayFollowup"].map((tab) => (
            <TouchableOpacity
              key={tab}
              style={[
                VisitListTabStyles.tab,
                activeTab === tab && VisitListTabStyles.activeTab,
              ]}
              onPress={() => setActiveTab(tab)}>
              <Text
                style={[
                  VisitListTabStyles.tabText,
                  activeTab === tab && VisitListTabStyles.activeTabText,
                ]}>
        ...
        <View style={VisitListTabStyles.searchRow}>
          <TextInput
            style={VisitListTabStyles.searchInput}
            placeholder="Search"
            value={searchText}
            onChangeText={setSearchText}
          />
          <TouchableOpacity
            style={VisitListTabStyles.plusButton}
            onPress={() => setModalVisible(true)}
          >
            <Icon name="add" size={24} color="#fff" />
          </TouchableOpacity>
        </View>
      {/* <Text style={VisitListTabStyles.totalCountTextlabel}>
  Total List:{" "}
  <Text style={VisitListTabStyles.totalCountTextValue}>
    {activeTab === "CustomerList"
      ...
      : todayFollowupCount}
        ...
        >
          <View style={VisitListTabStyles.modalContainer}>
            <View style={VisitListTabStyles.modalContent}>
              <Pressable
                style={VisitListTabStyles.modalcard}
                onPress={() => {
                  setModalVisible(false);
                  navigation.navigate("CreateVisit");
                }}
              >
                <Text style={VisitListTabStyles.cardText}>Create Visit</Text>
              </Pressable>
              <Pressable
                style={VisitListTabStyles.modalcard}
                onPress={() => {
              ...
              >
                <Text style={VisitListTabStyles.cardText}>Create Customer</Text>
              </Pressable>
              <TouchableOpacity
                style={VisitListTabStyles.closeButton}
        ...
        <View style={{ flex: 1 }}>
          {activeTab === "VisitList" ? (
            postcreatevisitLoading ? (
              <View style={VisitListTabStyles.loader}>
                <ActivityIndicator size="large" color="#3966c2" />
                <Text style={VisitListTabStyles.loaderText}>
                  Loading Enquiries...
                </Text>
              </View>
            ) : (
              <View style={{ marginBottom: 20 }}>
                ...
                {filteredEnquiries.length > 0 ? (
                  ...
                  <View style={VisitListTabStyles.center}>
